...
profiles:
  - icon: at-symbol
    url: 'mailto:mikaranja@gmail.com'
    label: E-mail Me
  # - icon: brands/x
  ...
  - icon: brands/github
    url: https://github.com/mikaranja
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/mikaranja
  # - icon: academicons/google-scholar
  #   url: https://scholar.google.com/
  # - icon: academicons/orcid
  #   url: https://orcid.org/
  - icon: brands/whatsapp
    url: https://api.whatsapp.com/send?phone=+254705872780&text=Hello,%20I%20just%20saw%20your%20portfolio.
...
education:
  - area: Google Advanced Data Analytics Certificate
    institution: Coursera
    date_start: 2024
    date_end: 2023
  - area: Data Analyst in SQL
    institution: DataCamp
    date_start: 2023
    date_end: 2023
  - area: Google Data Analytics Certificate
    institution: Coursera
    date_start: 2023
    date_end: 2023
  - area: Bachelor of Science (B.Sc.)
